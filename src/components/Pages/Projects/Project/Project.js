	...
	return (
		<Grid item xs={12} className={classes.root}>
			<div className={classes.titleContainer}>
				<ProjectTitle date={props.date} url={props.url} name={props.name} />
			</div>
			<div className={classes.imageText}>
				<ProjectImage image={props.image} className={classes.image} />
				<div className={classes.info}>
					<ProjectDescription description={props.description} />
					<div className={classes.btnContainer}>
						<Button variant="outlined" className={classes.button} href={props.url} target="_blank">
			...
			<div className={classes.stackContainer}>
				<div className={classes.toggleStackContainer}>
					<Stack className={classes.stack} {...props.stack} />
				</div>
			</div>
		</Grid>
	);
